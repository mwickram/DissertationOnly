function construct_attractor_fourglobal

data1=load('m041411_15.dat');
...
p=plot3(px(1),px2(1),px3(1),'o',px(3),px2(3),px3(3),'o');
q=plot3(px(2),px2(2),px3(2),'o',px(4),px2(4),px3(4),'^');
a=0.1; b=0.5;
...
print -r300 -dtiff attractor_m041411_15.tiff
